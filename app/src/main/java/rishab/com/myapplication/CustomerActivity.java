...
public class CustomerActivity extends AppCompatActivity implements LocationListener {
    ...
    Location agentloc = new Location("agentloc");
    ...
    public void DelayNotification(Location agentloc,Location userloc){

        Float dist = agentloc.distanceTo(userloc);
        //setting the distance between the user and the agent for the first time after pickup
